...
public class JSONLoader {
    ...
    private final ArrayList<String> exerciseCategories = new ArrayList<>();

    // ==============================================
    // ==============================================
    public ArrayList<Exercise> getExercisesFromFile(String filename, Context context) {
    ...
    // ==============================================
    // ==============================================
    private String loadJsonFromFile(String filename, Context context) {
